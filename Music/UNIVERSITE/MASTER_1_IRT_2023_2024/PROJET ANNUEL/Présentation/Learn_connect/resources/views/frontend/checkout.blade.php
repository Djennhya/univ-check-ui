    ...
    <div class="container">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 align-items-center">
                ...
                <li class="breadcrumb-item active"><a href="checkout.html" class="fs-6 text-secondary">Commande</a></li>
            </ol>
        </nav>
    </div>
</div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6 checkout-area-checkout">
                <h6 class="checkout-area__label">Commande</h6>
                                ...
                                <div class="mb-4">
                                    <div class="ps-0 ">
                                        <label class="text-danger">
                                            Veuillez vérifier vos cours avant de valider
                                        </label>
                                    </div>
                                </div>
                    ...
                    <div class="cart">
                        ...
                        <div class="cart__checkout-process">
                            <ul>
                                ...
                                <li>
                                    <p>Pas de coupon ({{session('cart_details')['discount'] ?? 0.00}}%)</p>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-6 offset-xl-3 order-2 order-xl-0">
                        <div class="signup-area-textwrapper">
                            <h2 class="font-title--md mb-0">Connectez-vous avant de commander</h2>
                            <p class="mt-2 mb-lg-4 mb-3">Pas de compte?
                            ...
                            <form action="{{route('studentLogin.check','checkout')}}" method="POST">
                                ...
                                <div class="form-element">
                                    ...
                                    <div class="form-alert-input">
                                        <input type="password" placeholder="Entrer le mot de passe" id="password"
                                            name="password" />
                                ...
                                <div class="form-element">
                                    <button type="submit" class="button button-lg button--primary w-100">Connectez-vous</button>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row align-items-center justify-content-md-center">
                    <div class="col-lg-5 order-2 order-lg-0">
                        <div class="signup-area-textwrapper">
                            <h2 class="font-title--md mb-0">Inscrivez-vous maintenant</h2>
                            <p class="mt-2 mb-lg-4 mb-3">Déja un compte? <a href="#" onclick="hide_signin()"
                                    class="text-black-50">Connectez-vous</a></p>
                            <form action="{{route('studentRegister.store','checkout')}}" method="POST">
                                ...
                                <div class="form-element">
                                    <label for="password_confirmation" class="w-100" style="text-align: left;">Confirmer mot de passe
                                        </label>
                                    <div class="form-alert-input">
                                ...
                                <div class="form-element">
                                    <button type="submit" class="button button-lg button--primary w-100">Valider</button>
                                </div>
                            </form>
                        </div>
                    </div>
