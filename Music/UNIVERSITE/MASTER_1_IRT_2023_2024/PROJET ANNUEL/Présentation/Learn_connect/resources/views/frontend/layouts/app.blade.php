            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse d-none d-xl-block d-none d-xl-block" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="{{route('searchCourse')}}">Cours</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="{{route('about')}}">A propos</a>
                        </li>
                        {{-- <li class="nav-item">
                    ...
                    <div class="d-flex align-items-center justify-content-between rightContent">
                        ...
                        <a href="{{route('cart')}}" class="cart-nav border-0 bg-transparent mx-3">
                            ...
                            <span class="visually-hidden">Ajouter article</span>
                        </a>
                        ...
                        <div class="dropdown user-image ms-3" id="imageDropdown">
                            ...
                            <div class="dropdown-content">
                                <a href="{{route('student_profile')}}">Profil</a>
                                <a href="{{route('studentdashboard')}}">Tableau de bord</a>
                                <a href="{{route('studentlogOut')}}" class="text-danger">Deconnexion</a>
                            </div>
                        </div>
                        @else
                        <a href="{{route('studentLogin')}}" class="button button--text">Connexion</a>
                        <a href="{{route('studentRegister')}}" class="button button--dark">Inscription</a>
                        @endif
                    </div>
                </div>
                        ...
                        <div class="navbar-mobile__menu">
                            <ul class="navbar-mobile__menu-list">
                                <li class="active navbar-mobile__menu-item">
                                    <a href="{{route('home')}}">
                                        <span class="navbar-mobile__menu-link"> Accueil</span>
                                    </a>
                                </li>
                                <li class="navbar-mobile__menu-item">
                                    <a href="{{route('searchCourse')}}">
                                        <span class="navbar-mobile__menu-link"> Cours </span>
                                    </a>
                                </li>
                                <li class="navbar-mobile__menu-item">
                                    <a href="{{route('about')}}">
                                        <span class="navbar-mobile__menu-link"> A propos </span>
                                    </a>
                                </li>
                                <li class="navbar-mobile__menu-item">
                                    <a href="#">
                                    ...
                                    <ul class="navbar-mobile__menu-dropmenu">
                                        <li><a href="{{route('searchCourse')}}">Cours</a></li>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="footer__wrapper">
                        ...
                        <p>
                            Learn-Connect est une plateforme intégrée conçue pour révolutionner 
                            l'apprentissage en ligne. Elle permet aux instructeurs de créer des 
                            cours interactifs, de télécharger du contenu éducatif, et d'évaluer 
                            les progrès des étudiants de manière efficace.
                        </p>
