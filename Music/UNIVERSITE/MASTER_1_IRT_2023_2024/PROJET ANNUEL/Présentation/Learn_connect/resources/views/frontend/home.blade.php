...
<!-- Banner Starts Here -->
<section class="main-banner" style="background-image: url({{asset('/frontend/dist/images/banner/em.jpg')}});">
    <div class="container">
        <div class="row">
            <div class="col-lg-7 mb-lg-0 order-2 order-lg-0 d-flex align-items-center">
                <div class="banner-two-start">
                    <h1 class="font-title--lg">Débloquez le savoir partout, à tout moment, avec des experts.</h1>
                    <p>
                        Notre engagement est de vous guider vers les meilleurs cours en ligne, en offrant des conseils d'experts à tout moment et partout où vous êtes.
                    </p>
                    <form>
                        <div class="banner-input">
                            <div class="main-input">
                                <input type="text" placeholder="Explorez les cours" />
                            ...
                            <div class="search-button">
                                <button class="button button-lg button--primary">Recherche</button>
                            </div>
                        </div>
                    </form>
                </div>
...
<section class="section browse-categories">
    <div class="container">
        <h2 class="font-title--md text-center mb-0">Parcourez les cours par catégories principales</h2>
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <a href="{{route('searchCourse')}}" class="button button-lg button--primary mt-5">Parcourir tous les cours</a>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-12">
                <div class="featured-popular-courses-heading d-flex align-content-center justify-content-between">
                    <div class="main-heading">
                        <h3 class="font-title--md">Nos cours populaires</h3>
                    </div>
        ...
        <div class="row">
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-all" role="tabpanel" aria-labelledby="pills-all-tab">
                            ...
                            <div class="contentCard contentCard--course">
                                ...
                                <div class="contentCard-bottom">
                                    ...
                                    <div class="contentCard-info d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="price">
                                            <span>{{$pc->price?''.$pc->price:'Gratuit'}}</span>
                                    ...
                                    <div class="contentCard-more">
                                        ...
                                        <div class="book d-flex align-items-center">
                                            ...
                                            <span>{{$pc->lesson?$pc->lesson:0}} Leçon</span>
                                        </div>
                                        <div class="clock d-flex align-items-center">
                                            ...
                                            <span>{{$pc->duration?$pc->duration:0}} Heures</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <a href="{{route('searchCourse')}}" class="button button-lg button--primary">Parcourir tous les cours</a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="contentCard contentCard--course">
                                ...
                                <div class="contentCard-bottom">
                                    ...
                                    <div class="contentCard-info d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="price">
                                            <span>{{$dc->price?''.$dc->price:'Gratuit'}}</span>
                                    ...
                                    <div class="contentCard-more">
                                        ...
                                        <div class="book d-flex align-items-center">
                                            ...
                                            <span>{{$dc->lesson?$dc->lesson:0}} Leçon</span>
                                        </div>
                                        <div class="clock d-flex align-items-center">
                                            <div class="icon">
                                                <img src="{{asset('/frontend/dist/images/icon/Clock.png')}}" alt="clock" />
                                            </div>
                                            <span>{{$dc->duration?$dc->duration:0}} Heures</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="contentCard contentCard--course">
                                ...
                                <div class="contentCard-bottom">
                                    ...
                                    <div class="contentCard-info d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="price">
                                            <span>{{$dv->price?''.$dv->price:'Gratuit'}}</span>
                                    ...
                                    <div class="contentCard-more">
                                        ...
                                        <div class="book d-flex align-items-center">
                                            ...
                                            <span>{{$dv->lesson?$dv->lesson:0}} Leçon</span>
                                        </div>
                                        <div class="clock d-flex align-items-center">
                                            <div class="icon">
                                                <img src="{{asset('/frontend/dist/images/icon/Clock.png')}}" alt="clock" />
                                            </div>
                                            <span>{{$dv->duration?$dv->duration:0}} Heures</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="tab-pane fade" id="pills-bus" role="tabpanel" aria-labelledby="pills-bus-tab">
                            ...
                            <div class="contentCard contentCard--course">
                                ...
                                <div class="contentCard-bottom">
                                    ...
                                    <div class="contentCard-info d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="price">
                                            <span>{{$bc->price?''.$bc->price:'Gratuit'}}</span>
                                    ...
                                    <div class="contentCard-more">
                                        ...
                                        <div class="clock d-flex align-items-center">
                                            ...
                                            <span>{{$bc->duration?$bc->duration:0}} Heures</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <a href="{{route('searchCourse')}}" class="button button-lg button--primary">Parcourir les cours</a>
                        </div>
                    </div>
                </div>
                <div class="tab-pane fade" id="pills-its" role="tabpanel" aria-labelledby="pills-its-tab">
                            ...
                            <div class="contentCard contentCard--course">
                                ...
                                <div class="contentCard-bottom">
                                    ...
                                    <div class="contentCard-info d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="price">
                                            <span>{{$ic->price?''.$ic->price:'Gratuit'}}</span>
                                    ...
                                    <div class="contentCard-more">
                                        ...
                                        <div class="book d-flex align-items-center">
                                            ...
                                            <span>{{$ic->lesson?$ic->lesson:0}} Leçon</span>
                                        </div>
                                        <div class="clock d-flex align-items-center">
                                            <div class="icon">
                                                <img src="{{asset('/frontend/dist/images/icon/Clock.png')}}" alt="clock" />
                                            </div>
                                            <span>{{$ic->duration?$ic->duration:0}} Heures</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <a href="{{route('searchCourse')}}" class="button button-lg button--primary">Parcourir les
                                cours</a>
                        </div>
                    </div>
                </div>
...
<section class="section feature section section--bg-offwhite-one">
    <div class="container">
        <h2 class="font-title--md text-center">Pourquoi vous apprendrez avec Learn-connect</h2>
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="cardFeature">
                    ...
                    <h5 class="font-title--xs">250 Cours en ligne</h5>
                    <p>
                        Explorez notre vaste bibliothèque de 250 cours en ligne, 
                        conçus pour répondre à divers intérêts et besoins professionnels.
                    </p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="cardFeature">
                    ...
                    <h5 class="font-title--xs">Des Experts Instructeurs</h5>
                    <p>
                        Apprenez auprès de nos experts instructeurs, des professionnels chevronnés dans leur domaine, 
                        des spécialistes passionnés
                    </p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="cardFeature">
                    ...
                    <h5 class="font-title--xs">Accès à vie</h5>
                    <p>
                        Profitez d'un accès illimité à vos cours, même après leur completion. 
                        Avec notre option d'accès à vie et vous pouvez revisiter les contenus 
                        .
                    </p>
                </div>
            </div>
            ...
            <div class="col-lg-6 order-2 order-lg-0">
                <div class="learning-rules-starts">
                    <h2 class="font-title--md">
                        Étapes d'apprentissage simples avec Learn-connect <br class="d-none d-md-block" />
                    ...
                    <div class="learning-rules__wrapper">
                        <div class="learning-rules-item">
                            ...
                            <div class="item-text">
                                <h6>Créez votre propre espace.</h6>
                                <p>
                                    Personnaliser ou d'aménager un espace selon ses propres préférences et besoins.
                                </p>
                            </div>
                        </div>
                        <div class="learning-rules-item">
                            ...
                            <div class="item-text">
                                <h6>Trouvez le meilleur cours avec un meilleur filtre.</h6>
                                <p>
                                    Utiliser des outils de filtrage améliorés pour 
                                    sélectionner les cours les plus appropriés ou de meilleure qualité.
                                </p>
                            </div>
                        </div>
                        <div class="learning-rules-item">
                            ...
                            <div class="item-text">
                                <h6>Et devenez un expert dans votre domaine.</h6>
                                <p>
                                    maîtriser complètement un domaine 
                                    spécifique grâce à l'apprentissage et à l'acquisition de compétences.
                                </p>
                            </div>
                        </div>
                    </div>
                    <a href="#" class="button button-lg button--primary">Commencez</a>
                </div>
            </div>
            <div class="col-lg-6 order-1 order-lg-0">
                <div class="learning-rules-ends">
                    <img src="{{asset('/frontend/dist/images/hero/home2.jpeg')}}" alt="img"
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 position-relative">
                <h3 class="text-center mb-40 font-title--md">Nos meilleures instructrices</h3>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="main-become-instructor-item me-12">
                    <div class="main-image">
                        <img src="{{asset('/frontend/dist/images/event/home.jpg')}}" alt="image"
                            class="img-fluid" />
                    </div>
                    <div class="main-text">
                        <h6 class="font-title--sm">Devenez instructeur</h6>
                        <p>
                            Partagez votre expertise et inspirez les apprenants du monde entier. En tant qu'instructeur, vous aurez l'opportunité de créer et de publier vos propres cours en ligne, de toucher 
                            une audience mondiale et de contribuer à l'éducation de milliers d'étudiants.
                        </p>
                        <div class="text-center">
                            <a href="#" class="green-btn">Postulez</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="main-become-instructor-item ms-12 mb-0">
                    <div class="main-image">
                        <img src="{{asset('/frontend/dist/images/event/home2.jpg')}}" alt="image"
                            class="img-fluid" />
                    </div>
                    <div class="main-text">
                        <h6 class="font-title--sm">Learn-connect business</h6>
                        <p>
                            Partagez votre expertise et aidez les entreprises à atteindre 
                            de nouveaux sommets. En tant qu'instructeur sur notre plateforme, 
                            vous pourrez créer des cours en ligne sur mesure, 
                            adaptés aux besoins spécifiques des entreprises et des professionnels. 
                        </p>
                        <div class="text-center">
                            <a href="#" class="green-btn">Explorez</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-8 mx-auto">
                <div class="newsletter-area">
                    ...
                    <p class="mt-2 mb-lg-4 mb-3">
                        Pour plus d'informations veuillez nous laisser un message. Merci!!!
                    </p>
                    <form>
                        <div class="input-group">
                            <input type="email" class="form-control border-lowBlack" placeholder="Votre email" />
