    ...
    <div class="container">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb align-items-center bg-transparent p-0 mb-0">
                ...
                <li class="breadcrumb-item">
                    <a href="course-search.html" class="fs-6 text-secondary">Cours</a>
                </li>
            </ol>
        </nav>
    </div>
                ...
                <div class="event-search-bar">
                    <form action="#">
                        <div class="form-input-group">
                            <input type="text" class="form-control" placeholder="Rechercher cours" />
                        ...
                        <div id="categoryCollapse" class="accordion-collapse collapse show"
                            ...
                            <div class="accordion-body">
                                <form action="{{route('searchCourse')}}" method="get">
                                    ...
                                    @empty
                                    @endforelse
                                    <button type="submit" class="btn btn-primary">Appliquez</button>
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <div class="event-search-results">
                    <div class="event-search-results-heading">
                        <div class="nice-select" tabindex="0">
                            <span class="current">Populaires</span>
                            <ul class="list">
                                ...
                                <li data-value="4" class="option">Option 3</li>
                            </ul>
                        </div>
                        <p>{{$course->count()}} Resultats trouvés.</p>
