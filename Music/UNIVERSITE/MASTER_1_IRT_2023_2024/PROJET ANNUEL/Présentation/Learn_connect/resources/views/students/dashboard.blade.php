    ...
    <div class="container">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb align-items-center bg-transparent mb-0">
                ...
                <li class="breadcrumb-item fs-6 text-secondary" aria-current="page">Mon Profil</li>
            </ol>
        </nav>
    </div>
</div>
            ...
            <nav class="students-info-intro__nav">
                <div class="nav" id="nav-tab" role="tablist">
                    ...
                    <button class="nav-link" id="nav-coursesall-tab" data-bs-toggle="tab"
                        ...
                        aria-selected="false">Cours inscrits</button>
                    ...
                    <button class="nav-link "><a href="{{route('student_profile')}}"
                            class="text-secondary">Profil</a></button>

                    <button class="nav-link "><a href="{{route('home')}}" class="text-secondary">Accueil</a></button>
                </div>
            </nav>
        </div>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-6 col-12 mx-auto text-center">
                                        <h5 class="font-title--sm">Booster votre cariere</h5>
                                        <p class="my-4 font-para--lg">
                                            Booster Votre Carrière est une initiative dédiée à propulser votre 
                                            développement professionnel. En offrant des outils de formation, 
                                            des conseils d'experts, et des opportunités de réseautage, 
                                            nous vous aidons à acquérir les compétences essentielles, 
                                            à atteindre vos objectifs de carrière, et à vous démarquer 
                                            dans votre domaine. Transformez votre potentiel en succès 
                                            avec notre soutien stratégique et nos ressources personnalisées.
                                        </p>
                                        <a href="{{route('searchCourse')}}"
                                            class="button button-md button--primary">C'est parti</a>
                                    </div>
                                </div>
                            </div>
                        </section>
                            ...
                            <div class="contentCard contentCard--watch-course">
                                ...
                                <div class="contentCard-bottom">
                                    ...
                                    <a class="button button-md button--primary-outline w-100 my-3"
                                        href="{{route('watchCourse', encryptor('encrypt', $a->course?->id))}}">Suivre</a>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-md-6 mb-4">
                            <div class="contentCard contentCard--watch-course">
                                <div class="contentCard-top">
                                    <a href="#"><img
                                            src="{{asset('/frontend/dist/images/courses/a.jpg')}}"
                                            alt="images" class="img-fluid" /></a>
                                </div>
                                <div class="contentCard-bottom">
                                    <h5>
                                        <a href="https://youtu.be/SsNtZgkOK8E?si=Zy0KnNr8LOTgykAN" class="font-title--card">Python analyse de données</a>
                                    </h5>
                                    <div class="contentCard-info d-flex align-items-center justify-content-between">
                                    ...
                                    <a class="button button-md button--primary-outline w-100 my-3" href="https://youtu.be/SsNtZgkOK8E?si=Zy0KnNr8LOTgykAN">Suivre</a>
                                    <div class="contentCard-watch--progress">
                                        <span class="percentage" style="width: 43%;"></span>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-md-6 mb-4">
                            <div class="contentCard contentCard--watch-course">
                                <div class="contentCard-top">
                                    <a href="#"><img
                                            src="{{asset('/frontend/dist/images/courses/b.jpg')}}"
                                            alt="images" class="img-fluid" /></a>
                                </div>
                                <div class="contentCard-bottom">
                                    <h5>
                                        <a href="#" class="font-title--card">Systeme d'information</a>
                                    </h5>
                                    <div class="contentCard-info d-flex align-items-center justify-content-between">
                                        <a href="instructor-profile.html"
                                            class="contentCard-user d-flex align-items-center">
                        ...
                        <div class="col-lg-4 col-md-6 col-md-6 mb-4">
                            <div class="contentCard contentCard--watch-course">
                                <div class="contentCard-top">
                                    <a href="#"><img
                                            src="{{asset('/frontend/dist/images/courses/d.jpg')}}"
                                            alt="images" class="img-fluid" /></a>
                                </div>
                                <div class="contentCard-bottom">
                                    <h5>
                                        <a href="#" class="font-title--card">Initiation a Python</a>
                                    </h5>
                                    <div class="contentCard-info d-flex align-items-center justify-content-between">
                                        <a href="instructor-profile.html"
                                            class="contentCard-user d-flex align-items-center">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-md-6 mb-4">
                            <div class="contentCard contentCard--watch-course">
                                <div class="contentCard-top">
                                    <a href="#"><img
                                            src="{{asset('/frontend/dist/images/courses/f.jpg')}}"
                                            alt="images" class="img-fluid" /></a>
                                </div>
                                <div class="contentCard-bottom">
                                    <h5>
                                        <a href="#" class="font-title--card">Anglais technique</a>
                                    </h5>
                                    <div class="contentCard-info d-flex align-items-center justify-content-between">
                                        <a href="instructor-profile.html"
                                            class="contentCard-user d-flex align-items-center">
                                            <img src="{{asset('/frontend/dist/images/courses/7.png')}}"
                                                alt="client-image" class="rounded-circle" />
                                            <p class="font-para--md">Mr. HOU Joseph</p>
                                        </a>
                                        <div class="contentCard-course--status d-flex align-items-center">
                                    ...
                                    <a class="button button-md button--primary-outline w-100 my-3" href="#">Suivre a nouveau</a>
                                    <div class="contentCard-watch--progress">
                        ...
                        <div class="col-lg-4 col-md-6 col-md-6 mb-4">
                            <div class="contentCard contentCard--watch-course">
                                <div class="contentCard-top">
                                    <a href="#"><img
                                            src="{{asset('/frontend/dist/images/courses/e.jpg')}}"
                                            alt="images" class="img-fluid" /></a>
                                </div>
                                <div class="contentCard-bottom">
                                    <h5>
                                        <a href="#" class="font-title--card">Entrepreneuriat</a>
                                    </h5>
                                    <div class="contentCard-info d-flex align-items-center justify-content-between">
                                        <a href="instructor-profile.html"
                                            class="contentCard-user d-flex align-items-center">
                                            <img src="{{asset('/frontend/dist/images/courses/7.png')}}"
                                                alt="client-image" class="rounded-circle" />
                                            <p class="font-para--md">Monsieur JUNK Koffi</p>
                                        </a>
                                        <div class="contentCard-course--status d-flex align-items-center">
                                            <span class="percentage">100%</span>
                                            <p>Finish</p>
                        ...
                        <div class="col-lg-4 col-md-6 col-md-6 mb-4">
                            <div class="contentCard contentCard--watch-course">
                                <div class="contentCard-top">
                                    <a href="#"><img
                                            src="{{asset('/frontend/dist/images/courses/c.jpg')}}"
                                            alt="images" class="img-fluid" /></a>
                                </div>
                                <div class="contentCard-bottom">
                                    <h5>
                                        <a href="https://youtu.be/KstwnJm4OO0?si=ENsb0oO2y3IubPvD" class="font-title--card">Gestion de projet</a>
                                    </h5>
                                    <div class="contentCard-info d-flex align-items-center justify-content-between">
                                        <a href="instructor-profile.html"
                                            class="contentCard-user d-flex align-items-center">
                                            <img src="{{asset('/frontend/dist/images/courses/7.png')}}"
                                                alt="client-image" class="rounded-circle" />
                                                <p class="font-para--md">Monsieur BRANDON Koffi</p>
                                        </a>
                                        <div class="contentCard-course--status d-flex align-items-center">
                                            <span class="percentage">100%</span>
                                            <p>Finish</p>
                                    ...
                                    <a class="button button-md button--primary-outline w-100 my-3" href="https://youtu.be/KstwnJm4OO0?si=ENsb0oO2y3IubPvD">Suivre a nouveau</a>
                                    <div class="contentCard-watch--progress">
                                        <span class="percentage" style="width: 100%;"></span>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex align-items-lg-center align-items-start flex-column flex-lg-row">
                                    ...
                                    <div class="purchase-area-items-end">
                                        ...
                                        <dl class="row">
                                            ...
                                            <dt class="col-sm-4">Total des cours</dt>
                                            <dd class="col-sm-8">
                                                {{$i}}
                                            </dd>
                                            <dt class="col-sm-4">Type de paiement</dt>
                                            <dd class="col-sm-8">
                                                {{$e->txnid}}
                                            </dd>
                                        </dl>
