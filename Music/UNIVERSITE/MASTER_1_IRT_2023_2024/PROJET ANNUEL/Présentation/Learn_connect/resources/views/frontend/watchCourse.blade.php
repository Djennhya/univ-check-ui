            ...
            <div class="coursedescription-header">
                <div class="coursedescription-header-start">
                    <a class="logo-image" href="{{route('home')}}">
                        <h5 style="font-style: italic; color: blue;">Learn-connect</h5>
                    </a>
                ...
                <div class="coursedescription-header-end">
                    ...
                    <a href="#" class="button button--text" data-bs-toggle="modal" data-bs-target="#ratingModal">Laisser un commentaire</a>
                ...
                <div class="course-description-start">
                    <div class="video-area">
                        <video controls id="myvideo" class="video-js w-100"
                            poster="{{asset('/frontend/dist/images/courses/11.jpg')}}">
                        ...
                        <nav class="course-description-start-content-tab">
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                ...
                                <button class="nav-link" id="nav-linstruc-tab" data-bs-toggle="tab"
                                    ...
                                    aria-selected="false">Intervenant</button>
                            </div>
                        </nav>
                        <div class="tab-content course-description-start-content-tabitem" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="nav-ldescrip" role="tabpanel"
                                ...
                                <div class="lesson-description">
                                    <p>
                                        Plongez dans le monde du développement web avec un bootcamp 
                                        complet couvrant les technologies front-end et back-end. 
                                        De HTML et CSS à la programmation côté serveur, 
                                        ce cours vous dotera des compétences nécessaires 
                                ...
                                <div class="course-notes-area">
                                    <div class="course-notes">
                                        <div class="course-notes-item">
                                            <p>
                                                Il est crucial de comprendre les objectifs et le problème à résoudre tout en analysant 
                                                le marché et la concurrence pour définir le succès du projet et le positionner efficacement.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="nav-lcomments" role="tabpanel"
                                ...
                                <div class="lesson-comments">
                                    <div class="feedback-comment pt-0 ps-0 pe-0">
                                        <h6 class="font-title--card">Commentaire</h6>
                                        <form action="#">
                                            <label for="comment">Commentez-ici</label>
                                            <textarea class="form-control" id="comment" placeholder="Add a Public Comment"></textarea>
                                            <button type="submit" class="button button-md button--primary float-end">Valider</button>
                                        </form>
                                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Laisser un mot</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body text-center pt-0 pb-0">
                    <div class="modal-body-rating">
                        <p>4.5 <span>(Bien/Excellent)</span></p>
                ...
                <div class="modal-footer border-0">
                    <form action="#" class="w-100">
                        ...
                        <button type="submit" class="button button-md button--primary w-100">Valider</button>
                    </form>
                </div>
            </div>
        </div>
