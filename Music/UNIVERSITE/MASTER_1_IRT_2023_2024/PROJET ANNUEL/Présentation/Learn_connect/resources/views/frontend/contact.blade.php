        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="hero__img-content">
                    <div class="hero__img-content--main">
                        <img src="{{asset('/frontend/dist/images/contact/woman1.png')}}" alt="image" />
                    </div>
            ...
            <div class="col-lg-6">
                <div class="hero__content-info">
                    <h2 class="font-title--md mb-0">Nos Branches</h2>
                    <p class="font-para--lg">
                        Nous sommes présents dans plusieurs régions avec des branches 
                        qui offrent des formations et un soutien local. Nos branches 
                        sont stratégiquement situées pour servir au mieux nos partenaires 
                        éducatifs et professionnels, en fournissant des ressources adaptées 
        ...
        <div class="row">
            ...
            <div class="col-lg-7 form-area">
                <form action="#">
                    ...
                    <div class="row">
                        <div class="text-end">
                            <button type="submit" class="button button-lg button--primary fw-normal">Envoyer</button>
                        </div>
                    </div>
                </form>
